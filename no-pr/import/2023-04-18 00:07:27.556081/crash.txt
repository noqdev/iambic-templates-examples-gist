Traceback (most recent call last):
  ...
  File "/Python-3.11.1/Lib/concurrent/futures/thread.py", line 58, in run
    result = self.fn(*self.args, **self.kwargs)
             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
FileNotFoundError: [Errno 2] No such file or directory: '/tmp/lambda87456oj8/.iambic/repos/resources/google_workspace/group/iambic.org/iambic_test_group.yaml'
