Traceback (most recent call last):
  ...
  File "/Python-3.11.1/Lib/concurrent/futures/thread.py", line 58, in run
    result = self.fn(*self.args, **self.kwargs)
             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
FileNotFoundError: [Errno 2] No such file or directory: '/tmp/lambdafjqffuo1/.iambic/repos/resources/google_workspace/group/iambic.org/iambic_test_group_9bca5dc0_2351_4990_8c00_93302adfbd5f.yaml'
