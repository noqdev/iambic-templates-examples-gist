Traceback (most recent call last):
  ...
  File "/app/iambic/plugins/v0_1_0/okta/group/template_generation.py", line 80, in generate_group_templates
  ...
  File "/Python-3.11.1/Lib/concurrent/futures/thread.py", line 58, in run
    result = self.fn(*self.args, **self.kwargs)
             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
FileNotFoundError: [Errno 2] No such file or directory: '/tmp/lambdawrm1aysq/.iambic/repos/resources/aws/organizations/scp/iambic_test_org_account/iambic_test_1795.yaml'
